...
[ApiController]
[Route("admin/loai-danh-muc")]
[Authorize(Roles = "admin")]
public class LoaiDanhMucQtController : ControllerBase
{
    private readonly BLL.Interfaces.ILoaiDanhMucBll _bll;

    public LoaiDanhMucQtController(BLL.Interfaces.ILoaiDanhMucBll bll)
    {
        _bll = bll;
    }
    ...
    public async Task<ActionResult<ApiResponse<LoaiDanhMucDto>>> LayChiTiet(int id, CancellationToken ct = default)
    {
        ...
        return Ok(ApiResponse<LoaiDanhMucDto>.Ok(data, "Lấy chi tiết thành công"));
    }
